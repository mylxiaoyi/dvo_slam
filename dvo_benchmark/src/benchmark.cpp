...
dvo::core::RgbdImagePyramid::Ptr load (std::string rgb_file, std::string depth_file)
{
    ...
    dvo::core::RgbdImagePyramid::Ptr result (
    new dvo::core::RgbdImagePyramid (grey_s16, depth_float));
...
: nh_ (nh), nh_private_ (nh_private), trajectory_out_ (0), groundtruth_reader_ (0),
  rgbdpair_reader_ (0), dump_camera_pose_ (false), load_camera_pose_ (false)
{
}
...
void BenchmarkNode::run ()
{
    ...
    {
        visualizer =
        new dvo::visualization::PclCameraTrajectoryVisualizer (!cfg_.RenderVideo);
        ((dvo::visualization::PclCameraTrajectoryVisualizer*)visualizer)
        ...
        if (cfg_.RenderVideo)
        {
            ...
            ((dvo::visualization::PclCameraTrajectoryVisualizer*)visualizer)->visualizer ().getRenderWindow ()->SetSize (
            1280, 960);
        }
    }
    else
         ...
         ++it)
    {
        ...
        if (cfg_.RenderVideo)
        {
            ...
            ((dvo::visualization::PclCameraTrajectoryVisualizer*)visualizer)->visualizer ().saveScreenshot (
            frame_ids.next () + std::string (".png"));
        }
    }
