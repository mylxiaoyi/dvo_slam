...
{
public:
//    void static BundleAdjustment (const vector<std::shared_ptr<KeyFrame>>& vpKF,
//                                  const vector<std::shared_ptr<MapPoint>>& vpMP,
//                                  int nIterations = 5,
//                                  bool* pbStopFlag = NULL,
//                                  const unsigned long nLoopKF = 0,
//                                  const bool bRobust = true);
//    void static GlobalBundleAdjustemnt (std::shared_ptr<Map> pMap,
//                                        int nIterations = 5,
//                                        bool* pbStopFlag = NULL,
//                                        const unsigned long nLoopKF = 0,
//                                        const bool bRobust = true);
...
//    static int OptimizeSim3 (std::shared_ptr<KeyFrame> pKF1,
...
//    static int OptimizeSim3FitGPS(std::vector<std::shared_ptr<KeyFrame> > &vpKFs,
