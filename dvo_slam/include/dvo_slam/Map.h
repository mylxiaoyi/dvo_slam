...
class Map {
 public:
  ...
  void EraseKeyFrame(boost::shared_ptr<Keyframe> pKF);
  ...
  std::vector<boost::shared_ptr<Keyframe>> GetAllKeyFrames();
  std::vector<boost::shared_ptr<MapPoint>> GetAllMapPoints();
  std::vector<boost::shared_ptr<MapPoint>> GetReferenceMapPoints();
  ...
  std::vector<boost::shared_ptr<Keyframe>> mvpKeyFrameOrigins;
 ...
 protected:
  ...
  std::vector<boost::shared_ptr<MapPoint>> mvpReferenceMapPoints;
