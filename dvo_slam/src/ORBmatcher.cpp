...
//                             vector<std::shared_ptr<MapPoint>>& vpMapPointMatches)
//{
//    const vector<std::shared_ptr<MapPoint>> vpMapPointsKF = pKF1->GetMapPointMatches ();
...
//                        if (mbCheckOrientation)
//                        {
//                            float rot = kp.angle - pKF2->mvKeys[bestIdxF].angle;
//                            if (rot < 0.0) rot += 360.0f;
//                            int bin = round (rot * factor);
//                            if (bin == HISTO_LENGTH) bin = 0;
//                            assert (bin >= 0 && bin < HISTO_LENGTH);
...
int ORBmatcher::SearchForTriangulation (boost::shared_ptr<Keyframe> pKF1,
...
//                else
                    vIndices2 =
                    CurrentFrame->GetFeaturesInArea (uv[0], uv[1], radius, nLastOctave - 1,
                                                     nLastOctave + 1);
