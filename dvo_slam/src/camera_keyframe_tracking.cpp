...
void CameraKeyframeTracker::handleTrackerConfig (dvo_ros::CameraDenseTrackerConfig& config,
                                                 uint32_t level)
{
    if (level == 0) return;
...
void CameraKeyframeTracker::handleImages (const sensor_msgs::Image::ConstPtr& rgb_image_msg,
...
void CameraKeyframeTracker::handleImages (const sensor_msgs::ImageConstPtr& rgb_image_msg,
